...
if __name__ == "__main__":
    ...
    method_list = [
                    ...
                    {"name": "OURS_EqVar", "gt_perm": False, "order": "EqVar"},
                    {"name": "OURS_NPVar", "gt_perm": False, "order": "NPVar"},
                    {"name": "OURS_SCORE", "gt_perm": False, "order": "SCORE"},
                    {"name": "OURS_GT", "gt_perm": True, "order": None},
                ]
    ...
    res_df.to_csv(f"results/ours_ablation_j_{args.model[:3]}_{args.graph_prior}-{args.edges_per_node//2}_d{args.n_vars}-m{args.n_particles}-T{args.steps}_n{args.n_obs}_r{args.n_runs}_s{args.seed}_{args.exp_name}.csv")
    print(res_df)