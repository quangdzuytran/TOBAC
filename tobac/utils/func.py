...
def strictly_lower(g):
    """
    Returns the strictly lower triangular matrix from the argument matrix
    """
    return jnp.tril(g, k=-1)

def lower(g):
    """
    Returns the lower triangular matrix from the argument matrix
    """
    return jnp.tril(g, k=0) 

def strictly_upper(g):
    """
    Returns the strictly upper triangular matrix from the argument matrix
    """
    return jnp.triu(g, k=1)

def upper(g):
    """
    Returns the upper triangular matrix from the argument matrix
    """
    return jnp.triu(g, k=0)
